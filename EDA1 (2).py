...
sns.swarmplot(data=data1, x = "Weather",y = "Ozone",color = "Yellow" ,palette = "Set2",size = 6)


# In[28]:


sns.stripplot(data=data1, x = "Weather",y = "Ozone",color = "Yellow" ,palette = "Set2",size = 6,jitter = True)
